...
public class FileBloomFilterTests {

    String path = "/tmp/test";

    String prefix = "async-slot-bloom-filter-test";
    ...
    public void before() {
        bf1 = DefaultSlotBloomFilter.create(slotStrategy, strategy,
            (i, p) -> DefaultBloomFilter.create(new FileBitMap(Paths.get(Slots.identifier(path + "/" + prefix, i)), p.bitSize), strategy, p));
